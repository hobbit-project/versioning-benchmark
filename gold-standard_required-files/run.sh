...
echo $(date +%H:%M:%S.%N | cut -b1-12)" : Running the component for computing gold standard..."
java -cp /versioning/versioning.jar org.hobbit.core.run.ComponentStarter org.hobbit.benchmark.versioning.gs.VirtuosoGoldStandard
