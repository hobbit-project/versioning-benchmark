...
dockerize:
	...
	docker build -f docker/versioningvirtuosogs.docker -t git.project-hobbit.eu:4567/papv/versioningvirtuosogs .
	...
	docker push git.project-hobbit.eu:4567/papv/versioningvirtuosogs
